...
export interface GetUserInviteCountReq {
  userId: number;
}

export interface GetUserInviteCountResp {
  count: number;
  /** 最大奖励 */
  maxReward: string;
}
...
export interface GetUserDetailInfoReq {
  userId: number;
}

export interface GetUserKycListReq {
  offset: number;
  limit: number;
  omitCount: boolean;
  userId: number;
...
export interface GetUserKycListResp {
  count: number;
  list: GetUserKycDetailInfoReply[];
}
...
function createBaseGetUserInviteCountReq(): GetUserInviteCountReq {
  return { userId: 0 };
}

export const GetUserInviteCountReq: MessageFns<GetUserInviteCountReq> = {
  encode(message: GetUserInviteCountReq, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.userId !== 0) {
      writer.uint32(8).uint64(message.userId);
    }
    return writer;
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): GetUserInviteCountReq {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseGetUserInviteCountReq();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
  ...
  fromJSON(object: any): GetUserInviteCountReq {
    return { userId: isSet(object.userId) ? globalThis.Number(object.userId) : 0 };
  },

  toJSON(message: GetUserInviteCountReq): unknown {
    const obj: any = {};
    if (message.userId !== 0) {
      obj.userId = Math.round(message.userId);
    }
  ...
  create(base?: DeepPartial<GetUserInviteCountReq>): GetUserInviteCountReq {
    return GetUserInviteCountReq.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<GetUserInviteCountReq>): GetUserInviteCountReq {
    const message = createBaseGetUserInviteCountReq();
    message.userId = object.userId ?? 0;
    return message;
  },
...
function createBaseGetUserInviteCountResp(): GetUserInviteCountResp {
  return { count: 0, maxReward: "" };
}

export const GetUserInviteCountResp: MessageFns<GetUserInviteCountResp> = {
  encode(message: GetUserInviteCountResp, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.count !== 0) {
      writer.uint32(8).uint64(message.count);
    }
    if (message.maxReward !== "") {
      writer.uint32(18).string(message.maxReward);
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): GetUserInviteCountResp {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseGetUserInviteCountResp();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
        ...
        case 2: {
          ...
          message.maxReward = reader.string();
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
  ...
  fromJSON(object: any): GetUserInviteCountResp {
    return {
      count: isSet(object.count) ? globalThis.Number(object.count) : 0,
      maxReward: isSet(object.maxReward) ? globalThis.String(object.maxReward) : "",
    };
  },

  toJSON(message: GetUserInviteCountResp): unknown {
    const obj: any = {};
    if (message.count !== 0) {
      obj.count = Math.round(message.count);
    }
    if (message.maxReward !== "") {
      obj.maxReward = message.maxReward;
    }
    return obj;
  },

  create(base?: DeepPartial<GetUserInviteCountResp>): GetUserInviteCountResp {
    return GetUserInviteCountResp.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<GetUserInviteCountResp>): GetUserInviteCountResp {
    const message = createBaseGetUserInviteCountResp();
    message.count = object.count ?? 0;
...
function createBaseGetUserListReq(): GetUserListReq {
  return {
    offset: 0,
    limit: 0,
    omitCount: false,
...
export const GetUserListReq: MessageFns<GetUserListReq> = {
  encode(message: GetUserListReq, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.offset !== 0) {
    ...
    if (message.omitCount !== false) {
      writer.uint32(24).bool(message.omitCount);
    }
    if (message.userId !== 0) {
    ...
    if (message.mobileNumber !== "") {
      writer.uint32(74).string(message.mobileNumber);
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): GetUserListReq {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseGetUserListReq();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
  ...
  fromJSON(object: any): GetUserListReq {
    return {
      offset: isSet(object.offset) ? globalThis.Number(object.offset) : 0,
      limit: isSet(object.limit) ? globalThis.Number(object.limit) : 0,
      omitCount: isSet(object.omitCount) ? globalThis.Boolean(object.omitCount) : false,
      userId: isSet(object.userId) ? globalThis.Number(object.userId) : 0,
  ...
  toJSON(message: GetUserListReq): unknown {
    const obj: any = {};
    if (message.offset !== 0) {
      obj.offset = Math.round(message.offset);
    }
    ...
    if (message.omitCount !== false) {
      obj.omitCount = message.omitCount;
    }
    if (message.userId !== 0) {
      obj.userId = Math.round(message.userId);
    }
  ...
  create(base?: DeepPartial<GetUserListReq>): GetUserListReq {
    return GetUserListReq.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<GetUserListReq>): GetUserListReq {
    const message = createBaseGetUserListReq();
    message.offset = object.offset ?? 0;
    message.limit = object.limit ?? 0;
    message.omitCount = object.omitCount ?? false;
    message.userId = object.userId ?? 0;
    message.status = object.status ?? 0;
...
function createBaseGetUserListResp(): GetUserListResp {
  return { count: 0, list: [] };
}

export const GetUserListResp: MessageFns<GetUserListResp> = {
  encode(message: GetUserListResp, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.count !== 0) {
      writer.uint32(8).int64(message.count);
    }
    for (const v of message.list) {
      UserDetailInfo.encode(v!, writer.uint32(18).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): GetUserListResp {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseGetUserListResp();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
        ...
        case 2: {
          ...
          message.list.push(UserDetailInfo.decode(reader, reader.uint32()));
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
  ...
  fromJSON(object: any): GetUserListResp {
    return {
      count: isSet(object.count) ? globalThis.Number(object.count) : 0,
      list: globalThis.Array.isArray(object?.list) ? object.list.map((e: any) => UserDetailInfo.fromJSON(e)) : [],
    };
  },

  toJSON(message: GetUserListResp): unknown {
    const obj: any = {};
    if (message.count !== 0) {
      obj.count = Math.round(message.count);
    }
    if (message.list?.length) {
      obj.list = message.list.map((e) => UserDetailInfo.toJSON(e));
    }
    return obj;
  },

  create(base?: DeepPartial<GetUserListResp>): GetUserListResp {
    return GetUserListResp.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<GetUserListResp>): GetUserListResp {
    const message = createBaseGetUserListResp();
    message.count = object.count ?? 0;
    message.list = object.list?.map((e) => UserDetailInfo.fromPartial(e)) || [];
    return message;
  },
};

function createBaseUserDetailInfo(): UserDetailInfo {
  return {
    userId: 0,
    username: "",
    nickname: "",
...
export const UserDetailInfo: MessageFns<UserDetailInfo> = {
  encode(message: UserDetailInfo, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.userId !== 0) {
      writer.uint32(8).uint64(message.userId);
    }
    if (message.username !== "") {
    ...
    if (message.fiatCurrency !== "") {
      writer.uint32(42).string(message.fiatCurrency);
    }
    if (message.notificationOn !== false) {
      writer.uint32(48).bool(message.notificationOn);
    }
    if (message.locale !== "") {
    ...
    if (message.mobileCode !== "") {
      writer.uint32(114).string(message.mobileCode);
    }
    if (message.mobileNumber !== "") {
      writer.uint32(122).string(message.mobileNumber);
    }
    if (message.countryCode !== "") {
      writer.uint32(130).string(message.countryCode);
    }
    if (message.internalUserId !== "") {
      writer.uint32(138).string(message.internalUserId);
    }
    if (message.externalUserId !== "") {
      writer.uint32(146).string(message.externalUserId);
    }
    if (message.inviteCode !== "") {
      writer.uint32(154).string(message.inviteCode);
    }
    if (message.inviter !== 0) {
      writer.uint32(160).uint64(message.inviter);
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): UserDetailInfo {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseUserDetailInfo();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
        ...
        case 20: {
          ...
          message.inviter = longToNumber(reader.uint64());
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
  ...
  fromJSON(object: any): UserDetailInfo {
    return {
      userId: isSet(object.userId) ? globalThis.Number(object.userId) : 0,
      username: isSet(object.username) ? globalThis.String(object.username) : "",
      nickname: isSet(object.nickname) ? globalThis.String(object.nickname) : "",
      ...
      externalUserId: isSet(object.externalUserId) ? globalThis.String(object.externalUserId) : "",
      inviteCode: isSet(object.inviteCode) ? globalThis.String(object.inviteCode) : "",
      inviter: isSet(object.inviter) ? globalThis.Number(object.inviter) : 0,
    };
  },

  toJSON(message: UserDetailInfo): unknown {
    const obj: any = {};
    if (message.userId !== 0) {
      obj.userId = Math.round(message.userId);
    }
    ...
    if (message.inviter !== 0) {
      obj.inviter = Math.round(message.inviter);
    }
    return obj;
  },

  create(base?: DeepPartial<UserDetailInfo>): UserDetailInfo {
    return UserDetailInfo.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<UserDetailInfo>): UserDetailInfo {
    const message = createBaseUserDetailInfo();
    message.userId = object.userId ?? 0;
    message.username = object.username ?? "";
    message.nickname = object.nickname ?? "";
...
function createBaseGetUserDetailInfoReq(): GetUserDetailInfoReq {
  return { userId: 0 };
}

export const GetUserDetailInfoReq: MessageFns<GetUserDetailInfoReq> = {
  encode(message: GetUserDetailInfoReq, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.userId !== 0) {
      writer.uint32(8).uint64(message.userId);
    }
    return writer;
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): GetUserDetailInfoReq {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseGetUserDetailInfoReq();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
  ...
  fromJSON(object: any): GetUserDetailInfoReq {
    return { userId: isSet(object.userId) ? globalThis.Number(object.userId) : 0 };
  },

  toJSON(message: GetUserDetailInfoReq): unknown {
    const obj: any = {};
    if (message.userId !== 0) {
      obj.userId = Math.round(message.userId);
    }
  ...
  create(base?: DeepPartial<GetUserDetailInfoReq>): GetUserDetailInfoReq {
    return GetUserDetailInfoReq.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<GetUserDetailInfoReq>): GetUserDetailInfoReq {
    const message = createBaseGetUserDetailInfoReq();
    message.userId = object.userId ?? 0;
    return message;
  },
...
function createBaseGetUserKycListReq(): GetUserKycListReq {
  return { offset: 0, limit: 0, omitCount: false, userId: 0, startTime: 0, endTime: 0, email: "", mobileNumber: "" };
}

export const GetUserKycListReq: MessageFns<GetUserKycListReq> = {
  encode(message: GetUserKycListReq, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.offset !== 0) {
      writer.uint32(8).uint64(message.offset);
    }
    if (message.limit !== 0) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): GetUserKycListReq {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseGetUserKycListReq();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
  ...
  fromJSON(object: any): GetUserKycListReq {
    return {
      offset: isSet(object.offset) ? globalThis.Number(object.offset) : 0,
      limit: isSet(object.limit) ? globalThis.Number(object.limit) : 0,
      omitCount: isSet(object.omitCount) ? globalThis.Boolean(object.omitCount) : false,
  ...
  toJSON(message: GetUserKycListReq): unknown {
    const obj: any = {};
    if (message.offset !== 0) {
      obj.offset = Math.round(message.offset);
    }
  ...
  create(base?: DeepPartial<GetUserKycListReq>): GetUserKycListReq {
    return GetUserKycListReq.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<GetUserKycListReq>): GetUserKycListReq {
    const message = createBaseGetUserKycListReq();
    message.offset = object.offset ?? 0;
    message.limit = object.limit ?? 0;
    message.omitCount = object.omitCount ?? false;
...
function createBaseGetUserKycListResp(): GetUserKycListResp {
  return { count: 0, list: [] };
}

export const GetUserKycListResp: MessageFns<GetUserKycListResp> = {
  encode(message: GetUserKycListResp, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.count !== 0) {
      writer.uint32(8).int64(message.count);
    }
    for (const v of message.list) {
      GetUserKycDetailInfoReply.encode(v!, writer.uint32(18).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): GetUserKycListResp {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseGetUserKycListResp();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
        ...
        case 2: {
          ...
          message.list.push(GetUserKycDetailInfoReply.decode(reader, reader.uint32()));
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
  ...
  fromJSON(object: any): GetUserKycListResp {
    return {
      count: isSet(object.count) ? globalThis.Number(object.count) : 0,
      list: globalThis.Array.isArray(object?.list)
        ? object.list.map((e: any) => GetUserKycDetailInfoReply.fromJSON(e))
        : [],
    };
  },

  toJSON(message: GetUserKycListResp): unknown {
    const obj: any = {};
    if (message.count !== 0) {
      obj.count = Math.round(message.count);
    }
    if (message.list?.length) {
      obj.list = message.list.map((e) => GetUserKycDetailInfoReply.toJSON(e));
    }
    return obj;
  },

  create(base?: DeepPartial<GetUserKycListResp>): GetUserKycListResp {
    return GetUserKycListResp.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<GetUserKycListResp>): GetUserKycListResp {
    const message = createBaseGetUserKycListResp();
    message.count = object.count ?? 0;
    message.list = object.list?.map((e) => GetUserKycDetailInfoReply.fromPartial(e)) || [];
    return message;
  },
};
...
export const UserDefinition = {
  ...
  methods: {
    ...
    /** 获取用户邀请人数 */
    getUserInviteCount: {
      name: "GetUserInviteCount",
      requestType: GetUserInviteCountReq,
      requestStream: false,
      responseType: GetUserInviteCountResp,
      responseStream: false,
      options: {},
    },
    /** 获取支持的国家和手机区号 */
...
export interface UserServiceImplementation<CallContextExt = {}> {
  ...
  /** 获取用户邀请人数 */
  getUserInviteCount(
    request: GetUserInviteCountReq,
    context: CallContext & CallContextExt,
  ): Promise<DeepPartial<GetUserInviteCountResp>>;
  /** 获取支持的国家和手机区号 */
  getSupportCountries(
    request: Empty,
    context: CallContext & CallContextExt,
...
export interface UserClient<CallOptionsExt = {}> {
  ...
  /** 获取用户邀请人数 */
  getUserInviteCount(
    request: DeepPartial<GetUserInviteCountReq>,
    options?: CallOptions & CallOptionsExt,
  ): Promise<GetUserInviteCountResp>;
  /** 获取支持的国家和手机区号 */
  getSupportCountries(
