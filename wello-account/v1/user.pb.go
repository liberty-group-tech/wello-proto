...
type LoginByPasswordReq struct {
	state           protoimpl.MessageState `protogen:"open.v1"`
	MobileCode      string                 `protobuf:"bytes,1,opt,name=mobile_code,json=mobileCode,proto3" json:"mobile_code,omitempty"`
	...
	ClientType      string                 `protobuf:"bytes,7,opt,name=client_type,json=clientType,proto3" json:"client_type,omitempty"`
	Ip              string                 `protobuf:"bytes,8,opt,name=ip,proto3" json:"ip,omitempty"`
	ForterMobileUid string                 `protobuf:"bytes,9,opt,name=forter_mobile_uid,json=forterMobileUid,proto3" json:"forter_mobile_uid,omitempty"`
...
func (x *LoginByPasswordReq) GetMobileNumber() string {
	if x != nil {
		return x.MobileNumber
	}
	return ""
...
func (x *LoginByPasswordReq) GetCountryCode() string {
	if x != nil {
		return x.CountryCode
	}
	return ""
...
func (x *LoginByPasswordReq) GetLocale() string {
	if x != nil {
		return x.Locale
	}
	return ""
...
func (x *LoginByPasswordReq) GetUserAgent() string {
	if x != nil {
		return x.UserAgent
	}
	return ""
...
func (x *LoginByPasswordReq) GetClientType() string {
	if x != nil {
		return x.ClientType
	}
	return ""
...
func (x *LoginByPasswordReq) GetIp() string {
	if x != nil {
		return x.Ip
	}
	return ""
...
func (x *LoginByPasswordReq) GetForterMobileUid() string {
	if x != nil {
		return x.ForterMobileUid
	}
	return ""
...
func (x *LoginByPasswordResp) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *LoginByPasswordResp) GetRefreshToken() string {
	if x != nil {
		return x.RefreshToken
	}
	return ""
...
const file_wello_account_v1_user_proto_rawDesc = "" +
	...
	"\x06signup\x18\x03 \x01(\bR\x06signup\"\xc3\x02\n" +
	"\x12LoginByPasswordReq\x12\x1f\n" +
	"\vmobile_code\x18\x01 \x01(\tR\n" +
	"mobileCode\x12#\n" +
	"\rmobile_number\x18\x02 \x01(\tR\fmobileNumber\x12!\n" +
	...
	"clientType\x12\x0e\n" +
	"\x02ip\x18\b \x01(\tR\x02ip\x12*\n" +
	"\x11forter_mobile_uid\x18\t \x01(\tR\x0fforterMobileUid\x12\x1a\n" +
	"\bpassword\x18\n" +
	" \x01(\tR\bpassword\"]\n" +
	"\x13LoginByPasswordResp\x12!\n" +
...
var file_wello_account_v1_user_proto_goTypes = []any{
	...
	(*LoginByPasswordReq)(nil),        // 8: user.service.v1.LoginByPasswordReq
	(*LoginByPasswordResp)(nil),       // 9: user.service.v1.LoginByPasswordResp
	(*CheckAccessTokenReq)(nil),       // 10: user.service.v1.CheckAccessTokenReq
	(*CheckAccessTokenReply)(nil),     // 11: user.service.v1.CheckAccessTokenReply
	(*GetAccessTokenReq)(nil),         // 12: user.service.v1.GetAccessTokenReq
	(*GetAccessTokenReply)(nil),       // 13: user.service.v1.GetAccessTokenReply
	(*GetUserInfoReq)(nil),            // 14: user.service.v1.GetUserInfoReq
	(*GetUserInfoReply)(nil),          // 15: user.service.v1.GetUserInfoReply
	(*QueryUserInfoReq)(nil),          // 16: user.service.v1.QueryUserInfoReq
	(*QueryUserInfoReply)(nil),        // 17: user.service.v1.QueryUserInfoReply
	(*GetUserMobileReq)(nil),          // 18: user.service.v1.GetUserMobileReq
	(*GetUserMobileReply)(nil),        // 19: user.service.v1.GetUserMobileReply
	(*GetUserEmailReq)(nil),           // 20: user.service.v1.GetUserEmailReq
	(*GetUserEmailReply)(nil),         // 21: user.service.v1.GetUserEmailReply
	(*CheckUsernameReq)(nil),          // 22: user.service.v1.CheckUsernameReq
	(*SetupUsernameReq)(nil),          // 23: user.service.v1.SetupUsernameReq
	(*SetupNicknameReq)(nil),          // 24: user.service.v1.SetupNicknameReq
	(*SetupDobReq)(nil),               // 25: user.service.v1.SetupDobReq
	(*SetupAvatarReq)(nil),            // 26: user.service.v1.SetupAvatarReq
	(*UpdateFiatCurrencyReq)(nil),     // 27: user.service.v1.UpdateFiatCurrencyReq
	(*UpdateNotificationOnReq)(nil),   // 28: user.service.v1.UpdateNotificationOnReq
	(*SetupPasswordReq)(nil),          // 29: user.service.v1.SetupPasswordReq
	(*BindEmailFlowCreateReq)(nil),    // 30: user.service.v1.BindEmailFlowCreateReq
	(*BindEmailFlowCreateReply)(nil),  // 31: user.service.v1.BindEmailFlowCreateReply
	(*BindEmailFlowSendReq)(nil),      // 32: user.service.v1.BindEmailFlowSendReq
	(*BindEmailFlowValidateReq)(nil),  // 33: user.service.v1.BindEmailFlowValidateReq
	(*BindOAuthFlowCreateReq)(nil),    // 34: user.service.v1.BindOAuthFlowCreateReq
	(*BindOAuthFlowCreateReply)(nil),  // 35: user.service.v1.BindOAuthFlowCreateReply
	(*BindOAuthFlowValidateReq)(nil),  // 36: user.service.v1.BindOAuthFlowValidateReq
	(*GetUserKycInfoReq)(nil),         // 37: user.service.v1.GetUserKycInfoReq
	(*GetUserKycInfoReply)(nil),       // 38: user.service.v1.GetUserKycInfoReply
	(*GetUserKycDetailInfoReq)(nil),   // 39: user.service.v1.GetUserKycDetailInfoReq
	(*GetUserKycDetailInfoReply)(nil), // 40: user.service.v1.GetUserKycDetailInfoReply
	(*KycDetailInfo)(nil),             // 41: user.service.v1.KycDetailInfo
	(*GetKycAccessTokenReq)(nil),      // 42: user.service.v1.GetKycAccessTokenReq
	(*GetKycAccessTokenReply)(nil),    // 43: user.service.v1.GetKycAccessTokenReply
	(*UploadKycResultReq)(nil),        // 44: user.service.v1.UploadKycResultReq
	(*LogoutReq)(nil),                 // 45: user.service.v1.LogoutReq
	(*CloseAccountPreCheckReq)(nil),   // 46: user.service.v1.CloseAccountPreCheckReq
	(*CloseAccountPreCheckResp)(nil),  // 47: user.service.v1.CloseAccountPreCheckResp
	(*CloseAccountReq)(nil),           // 48: user.service.v1.CloseAccountReq
	(*GetUserLimitsReq)(nil),          // 49: user.service.v1.GetUserLimitsReq
	(*GetUserLimitsResp)(nil),         // 50: user.service.v1.GetUserLimitsResp
	(*GetUserSavedWalletsReq)(nil),    // 51: user.service.v1.GetUserSavedWalletsReq
	(*GetUserSavedWalletsResp)(nil),   // 52: user.service.v1.GetUserSavedWalletsResp
	(*SavedWallet)(nil),               // 53: user.service.v1.SavedWallet
	(*UserAddSavedWalletReq)(nil),     // 54: user.service.v1.UserAddSavedWalletReq
	(*UserDeleteSavedWalletReq)(nil),  // 55: user.service.v1.UserDeleteSavedWalletReq
	(*UserUpdateSavedWalletReq)(nil),  // 56: user.service.v1.UserUpdateSavedWalletReq
...
var file_wello_account_v1_user_proto_depIdxs = []int32{
	...
	41, // 3: user.service.v1.GetUserKycDetailInfoReply.detail_info:type_name -> user.service.v1.KycDetailInfo
	53, // 4: user.service.v1.GetUserSavedWalletsResp.list:type_name -> user.service.v1.SavedWallet
	3,  // 5: user.service.v1.User.SignFlowCreate:input_type -> user.service.v1.SignFlowCreateReq
	5,  // 6: user.service.v1.User.SignFlowSend:input_type -> user.service.v1.SignFlowSendReq
	6,  // 7: user.service.v1.User.SignFlowValidate:input_type -> user.service.v1.SignFlowValidateReq
	8,  // 8: user.service.v1.User.LoginByPassword:input_type -> user.service.v1.LoginByPasswordReq
	10, // 9: user.service.v1.User.CheckAccessToken:input_type -> user.service.v1.CheckAccessTokenReq
	12, // 10: user.service.v1.User.GetAccessToken:input_type -> user.service.v1.GetAccessTokenReq
	14, // 11: user.service.v1.User.GetUserInfo:input_type -> user.service.v1.GetUserInfoReq
	16, // 12: user.service.v1.User.QueryUserInfo:input_type -> user.service.v1.QueryUserInfoReq
	18, // 13: user.service.v1.User.GetUserMobile:input_type -> user.service.v1.GetUserMobileReq
	20, // 14: user.service.v1.User.GetUserEmail:input_type -> user.service.v1.GetUserEmailReq
	22, // 15: user.service.v1.User.CheckUsername:input_type -> user.service.v1.CheckUsernameReq
	23, // 16: user.service.v1.User.SetupUsername:input_type -> user.service.v1.SetupUsernameReq
	24, // 17: user.service.v1.User.SetupNickname:input_type -> user.service.v1.SetupNicknameReq
	25, // 18: user.service.v1.User.SetupDob:input_type -> user.service.v1.SetupDobReq
	26, // 19: user.service.v1.User.SetupAvatar:input_type -> user.service.v1.SetupAvatarReq
	27, // 20: user.service.v1.User.UpdateFiatCurrency:input_type -> user.service.v1.UpdateFiatCurrencyReq
	28, // 21: user.service.v1.User.UpdateNotificationOn:input_type -> user.service.v1.UpdateNotificationOnReq
	29, // 22: user.service.v1.User.SetupPassword:input_type -> user.service.v1.SetupPasswordReq
	30, // 23: user.service.v1.User.BindEmailFlowCreate:input_type -> user.service.v1.BindEmailFlowCreateReq
	32, // 24: user.service.v1.User.BindEmailFlowSend:input_type -> user.service.v1.BindEmailFlowSendReq
	33, // 25: user.service.v1.User.BindEmailFlowValidate:input_type -> user.service.v1.BindEmailFlowValidateReq
	34, // 26: user.service.v1.User.BindOAuthFlowCreate:input_type -> user.service.v1.BindOAuthFlowCreateReq
	36, // 27: user.service.v1.User.BindOAuthFlowValidate:input_type -> user.service.v1.BindOAuthFlowValidateReq
	37, // 28: user.service.v1.User.GetUserKycInfo:input_type -> user.service.v1.GetUserKycInfoReq
	39, // 29: user.service.v1.User.GetUserKycDetailInfo:input_type -> user.service.v1.GetUserKycDetailInfoReq
	42, // 30: user.service.v1.User.GetKycAccessToken:input_type -> user.service.v1.GetKycAccessTokenReq
	44, // 31: user.service.v1.User.UploadKycResult:input_type -> user.service.v1.UploadKycResultReq
	58, // 32: user.service.v1.User.UpdateKycDetailPending:input_type -> google.protobuf.Empty
	58, // 33: user.service.v1.User.UpdateKycDetailAll:input_type -> google.protobuf.Empty
	45, // 34: user.service.v1.User.Logout:input_type -> user.service.v1.LogoutReq
	46, // 35: user.service.v1.User.CloseAccountPreCheck:input_type -> user.service.v1.CloseAccountPreCheckReq
	48, // 36: user.service.v1.User.CloseAccount:input_type -> user.service.v1.CloseAccountReq
	49, // 37: user.service.v1.User.GetUserLimits:input_type -> user.service.v1.GetUserLimitsReq
	51, // 38: user.service.v1.User.GetUserSavedWallets:input_type -> user.service.v1.GetUserSavedWalletsReq
	54, // 39: user.service.v1.User.UserAddSavedWallet:input_type -> user.service.v1.UserAddSavedWalletReq
	55, // 40: user.service.v1.User.UserDeleteSavedWallet:input_type -> user.service.v1.UserDeleteSavedWalletReq
	56, // 41: user.service.v1.User.UserUpdateSavedWallet:input_type -> user.service.v1.UserUpdateSavedWalletReq
	57, // 42: user.service.v1.User.BindInviter:input_type -> user.service.v1.BindInviterReq
	58, // 43: user.service.v1.User.GetSupportCountries:input_type -> google.protobuf.Empty
	4,  // 44: user.service.v1.User.SignFlowCreate:output_type -> user.service.v1.SignFlowCreateResp
	58, // 45: user.service.v1.User.SignFlowSend:output_type -> google.protobuf.Empty
	7,  // 46: user.service.v1.User.SignFlowValidate:output_type -> user.service.v1.SignFlowValidateResp
	9,  // 47: user.service.v1.User.LoginByPassword:output_type -> user.service.v1.LoginByPasswordResp
	11, // 48: user.service.v1.User.CheckAccessToken:output_type -> user.service.v1.CheckAccessTokenReply
	13, // 49: user.service.v1.User.GetAccessToken:output_type -> user.service.v1.GetAccessTokenReply
	15, // 50: user.service.v1.User.GetUserInfo:output_type -> user.service.v1.GetUserInfoReply
	17, // 51: user.service.v1.User.QueryUserInfo:output_type -> user.service.v1.QueryUserInfoReply
	19, // 52: user.service.v1.User.GetUserMobile:output_type -> user.service.v1.GetUserMobileReply
	21, // 53: user.service.v1.User.GetUserEmail:output_type -> user.service.v1.GetUserEmailReply
	58, // 54: user.service.v1.User.CheckUsername:output_type -> google.protobuf.Empty
	58, // 55: user.service.v1.User.SetupUsername:output_type -> google.protobuf.Empty
	58, // 56: user.service.v1.User.SetupNickname:output_type -> google.protobuf.Empty
	58, // 57: user.service.v1.User.SetupDob:output_type -> google.protobuf.Empty
	58, // 58: user.service.v1.User.SetupAvatar:output_type -> google.protobuf.Empty
	58, // 59: user.service.v1.User.UpdateFiatCurrency:output_type -> google.protobuf.Empty
	58, // 60: user.service.v1.User.UpdateNotificationOn:output_type -> google.protobuf.Empty
	58, // 61: user.service.v1.User.SetupPassword:output_type -> google.protobuf.Empty
	31, // 62: user.service.v1.User.BindEmailFlowCreate:output_type -> user.service.v1.BindEmailFlowCreateReply
	58, // 63: user.service.v1.User.BindEmailFlowSend:output_type -> google.protobuf.Empty
	58, // 64: user.service.v1.User.BindEmailFlowValidate:output_type -> google.protobuf.Empty
	35, // 65: user.service.v1.User.BindOAuthFlowCreate:output_type -> user.service.v1.BindOAuthFlowCreateReply
	58, // 66: user.service.v1.User.BindOAuthFlowValidate:output_type -> google.protobuf.Empty
	38, // 67: user.service.v1.User.GetUserKycInfo:output_type -> user.service.v1.GetUserKycInfoReply
	40, // 68: user.service.v1.User.GetUserKycDetailInfo:output_type -> user.service.v1.GetUserKycDetailInfoReply
	43, // 69: user.service.v1.User.GetKycAccessToken:output_type -> user.service.v1.GetKycAccessTokenReply
	58, // 70: user.service.v1.User.UploadKycResult:output_type -> google.protobuf.Empty
	58, // 71: user.service.v1.User.UpdateKycDetailPending:output_type -> google.protobuf.Empty
	58, // 72: user.service.v1.User.UpdateKycDetailAll:output_type -> google.protobuf.Empty
	58, // 73: user.service.v1.User.Logout:output_type -> google.protobuf.Empty
	47, // 74: user.service.v1.User.CloseAccountPreCheck:output_type -> user.service.v1.CloseAccountPreCheckResp
	58, // 75: user.service.v1.User.CloseAccount:output_type -> google.protobuf.Empty
	50, // 76: user.service.v1.User.GetUserLimits:output_type -> user.service.v1.GetUserLimitsResp
	52, // 77: user.service.v1.User.GetUserSavedWallets:output_type -> user.service.v1.GetUserSavedWalletsResp
	58, // 78: user.service.v1.User.UserAddSavedWallet:output_type -> google.protobuf.Empty
	58, // 79: user.service.v1.User.UserDeleteSavedWallet:output_type -> google.protobuf.Empty
	58, // 80: user.service.v1.User.UserUpdateSavedWallet:output_type -> google.protobuf.Empty
	58, // 81: user.service.v1.User.BindInviter:output_type -> google.protobuf.Empty
	1,  // 82: user.service.v1.User.GetSupportCountries:output_type -> user.service.v1.GetSupportCountriesResp
